    ...
    <div className="bg-[var(--bg-primary)]">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            <img src={interview} className="w-full rounded-lg border border-[var(--border-color)]" alt="" loading="lazy" />
          </div>
          <div className="lg:w-1/2 bg-[var(--bg-surface)] border border-[var(--border-color)] rounded-lg p-8 md:p-12 space-y-6">
            <h3 className="text-2xl md:text-3xl font-bold text-[var(--text-primary)]">Fresh Graduate Hiring</h3>
      ...
      <div className="py-16 md:py-24 px-6 bg-[var(--bg-surface)] border-y border-[var(--border-color)]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold text-center text-[var(--text-primary)] mb-16">Benefits</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="flex flex-col items-start p-8 border border-[var(--border-color)] bg-[var(--bg-primary)] rounded-lg card-hover">
                <div className="flex items-center space-x-4">
                  <i className={`fa-solid ${b.icon} fa-xl text-[#FED500]`}></i>
                  <h3 className="text-xl font-bold text-[var(--text-primary)]">{b.title}</h3>
                </div>
              </div>
            ))}
          </div>
